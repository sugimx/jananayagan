...
<div className="space-y-6 text-white leading-relaxed">
          ...
          <p>
            ...
            tvkcup2026.com/ ('Website'), including the related mobile site and mobile application (hereinafter
            referred to as 'Platform').
          </p>
          <p>
            3. The Platform is owned by SUGIMX PRIVATE LIMITED, a company incorporated under the
            Companies Act, 1956 with its registered office at TAMIL NADU ,Nagercoil ,India (hereinafter
          ...
          <p>
            ...
            jurisdiction of the courts in Nagercoil and Tamil Nadu
          </p>
          <p>
