...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: '/tvk_cup1.png', sizes: '48x48', type: 'image/png' },
      { url: '/tvk_cup1.png', sizes: '96x96', type: 'image/png' },
      { url: '/tvk_cup1.png', sizes: '128x128', type: 'image/png' },
    ],
    shortcut: '/tvk_cup1.png',
    apple: { url: '/tvk_cup1.png', sizes: '180x180', type: 'image/png' },
  },
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        <link rel="icon" href="/tvk_cup1.png" sizes="any" />
        <link rel="icon" href="/tvk_cup1.png" type="image/png" sizes="48x48" />
        <link rel="icon" href="/tvk_cup1.png" type="image/png" sizes="96x96" />
        <link rel="icon" href="/tvk_cup1.png" type="image/png" sizes="128x128" />
      </head>
      <body
