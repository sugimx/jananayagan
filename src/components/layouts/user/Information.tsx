                    ...
                    <form onSubmit={handleSubmit} className='flex-1 md:mx-12 w-[80%] my-4 flex gap-4 flex-col text-white'>
                        ...
                        <div className='flex flex-col gap-2'>
                            ...
                            <input 
                                ...
                                className='border-1 border-[#F5BB0B] outline-none rounded-lg py-2 px-2' 
                        ...
                        <div className='flex flex-col gap-2'>
                            ...
                            <textarea 
                                ...
                                onChange={handleInputChange}
                                className='border-1 border-[#F5BB0B] outline-none rounded-lg h-40 py-2 px-2' 
                                disabled={isSubmitting}
                            />
                        </div>
                        <button 
                            type="submit"
                            className='w-full bg-[#F5BB0B] rounded-md py-2 font-semibold disabled:opacity-50 disabled:cursor-not-allowed text-black cursor-pointer'
                            disabled={isSubmitting}
                        >
