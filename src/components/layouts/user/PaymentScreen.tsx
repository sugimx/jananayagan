                        ...
                        <div className='flex flex-col gap-4'>
                            <div>
                                ...
                                <AddressFormContainer>
                                    ...
                                    <input type="text" disabled name='name' placeholder='Enter your name here....' className='w-full h-full outline-none border-none text-black' />
                                </AddressFormContainer>
                            </div>
                            <div>
                                ...
                                <AddressFormContainer>
                                    ...
                                    <input type="text" disabled name='name' placeholder='Enter your city here....' className='w-full h-full outline-none border-none text-black' />
                                </AddressFormContainer>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <AddressFormContainer>
                                    ...
                                    <input type="text" disabled name='name' placeholder='Enter your address here....' className='w-full h-full outline-none border-none text-black' />
                                </AddressFormContainer>
                            </div>
                            <div>
                                ...
                                <AddressFormContainer>
                                    ...
                                    <input type="text" disabled name='name' placeholder='Enter your post code here....' className='w-full h-full outline-none border-none text-black' />
                                </AddressFormContainer>
                            </div>
                            <div>
