        ...
        <Container>
            <div className='w-[80%] mx-auto my-10 lg:flex lg:items-center'>
                <div className='leading-relaxed text-center lg:flex-[0.5] lg:text-start'>
                    <h1 className='text-3xl text-[#F5D57A] font-semibold my-2 md:text-[2rem]'>About Us - SUGIMX Private Limited</h1>
            ...
            <div className='w-[80%] mx-auto my-10 flex lg:items-center lg:justify-between flex-col lg:flex-row'>
                ...
                <div className='leading-relaxed text-center lg:flex-[0.5] lg:text-start order-1 lg:order-2'>
                    <h1 className='text-3xl text-[#F5D57A] font-semibold my-2 md:text-[2rem]'>Why This Project is Special?</h1>
                    <div className='text-justify text-sm md:text-[1rem] flex flex-col gap-2'>
            ...
            <div className='w-[80%] mx-auto my-10 flex lg:items-center lg:justify-between flex-col lg:flex-row'>
                <div className='leading-relaxed text-center lg:flex-[0.5] lg:text-start'>
                    <h1 className='text-3xl text-[#F5D57A] font-semibold my-2 md:text-[2rem]'>Our Mission</h1>
                    <div className='text-justify text-sm md:text-[1rem] flex flex-col gap-2'>
                        <p>To make Jana Nayagan 2026 not just a movie release, but a festival for fans across Tamil Nadu, Kerala, and beyond.</p>
                    </div> 
                    <h1 className='text-3xl text-[#F5D57A] font-semibold my-2 md:text-[2rem]'>Our Belief</h1>
                    <div className='text-justify text-sm md:text-[1rem] flex flex-col gap-2'>
            ...
            <div className='w-[80%] mx-auto my-10 flex lg:items-center lg:justify-between flex-col lg:flex-row'>
                ...
                <div className='leading-relaxed text-center lg:flex-1 lg:text-start order-1 lg:order-1'>
                    <h1 className='text-3xl text-[#F5D57A] font-semibold my-2 md:text-[2rem]'>Short About Us</h1>
                    <div className='text-justify text-sm md:text-[1rem] flex flex-col gap-2'>
