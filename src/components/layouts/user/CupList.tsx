...
const FALLBACK_CUP_DATA = [
  ...
  {
    "No": "2377",
    "Name": "AMIRTHA SANJEEVI",
    "Phone": "6381165346",
    "Location": "Manamelkudi , Pudukottai district",
    "Cup": "3175"
  },
  {
    "No": "2378",
  ...
  },
  {
    ...
    "Name": "R Megala",
    "Phone": "9043484711",
    "Location": "Coimbatore 641037",
    "Cup": "3193"
  },
  {
    "No": "2396",
    "Name": "Maheshwaran Ravi",
    "Phone": "9791797428",
    "Location": "Thanjavur",
    "Cup": "3194"
  },
...
const CupList = () => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          if (data.success && data.data) {
            ...
            console.warn('No data in response, using fallback data')
            setSampleDataRaw(FALLBACK_CUP_DATA)
          }
        } else {
          console.warn('Failed to fetch cup list:', response.status, '- Using fallback data')
          setSampleDataRaw(FALLBACK_CUP_DATA)
        }
      } catch (error) {
        console.warn('Error fetching cup list:', error, '- Using fallback data')
        setSampleDataRaw(FALLBACK_CUP_DATA)
      } finally {
        setLoading(false)
      }
  ...
  return (
    <Container>
      <div className="max-w-300 mx-auto my-6 md:my-10 px-3 md:px-4">
            ...
            {searchResults.length === 0 ? (
              ...
              <div className="flex flex-wrap justify-center gap-4 md:gap-6 max-w-5xl mx-auto">
                {searchResults.map((item, index) => (
                  <div 
                    key={`${item.Cup}-${index}`}
                    className="w-full md:w-[calc(50%-0.75rem)] lg:w-[calc(33.333%-1rem)] bg-linear-to-br from-[#1a1a1a] to-[#0b0b0b] border-2 border-[#F5BB0B] rounded-xl p-4 md:p-6 shadow-lg hover:shadow-[#F5BB0B]/20 transition-all duration-300"
                  >
                    ...
                    <div className="space-y-2 md:space-y-3">
                      <div>
                        ...
                        <p className="text-white font-semibold text-sm md:text-base wrap-break-word">{item.Name}</p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="text-white font-semibold text-sm md:text-base wrap-break-word">{item.Location}</p>
                      </div>
                    </div>
                  </div>
                ))}
