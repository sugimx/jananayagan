                ...
                <div className='md:flex gap-2 justify-center'>
                    <div className='my-5 text-white flex-1'>
                        <div className='flex flex-col gap-4'>
                            <div>
                                <label className='text-sm md:text-lg'>Address</label>
                            ...
                            </div>
                            {
                             ...
                             <div>
                                <label className='text-sm md:text-lg'>LandMark</label>
                                <AddressFormContainer>
                                    <AddressIcons Icon={FaUser} />
                                    <input 
                                        type="text" 
                            ...
                            <div>
                                <label className='text-sm md:text-lg'>Phone</label>
                                <AddressFormContainer>
                            ...
                            <div>
                                <label className='text-sm md:text-lg'>State</label>
                                <AddressFormContainer>
                                    <AddressIcons Icon={FaHome} />
                            ...
                            <div>
                                <label className='text-sm md:text-lg'>District</label>
                                <AddressFormContainer>
                            ...
                            <button 
                                className='bg-[#F5D57A] w-full py-2 my-3 text-sm uppercase font-medium cursor-pointer text-black' 
