...
const Footer = () => {
  return (
    <footer className="bg-[#7a0202] text-white px-4 pt-12 border-t-2 border-b-2 border-[#F5BB0B]">
        ...
        <div className="md:w-3/5 w-full grid grid-cols-1 sm:grid-cols-3 gap-8 my-auto text-center md:text-start">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm ">
                <li className=''> 
                    <a href="mailto:jananayagan.info@gmail.com" className="hover:text-[#F5BB0B] text-sm md:text-md xl:text-xl">jananayagan.info@gmail.com</a>
                </li>
            </ul>
          </div>
        </div>
