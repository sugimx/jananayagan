                        ...
                        <div className='relative flex flex-col gap-8'>
                            <div className='flex flex-col gap-6 md:flex-row md:items-center md:justify-between'>
                                ...
                                <div className='rounded-2xl border border-white/10 bg-white/5 px-6 py-4 text-center shadow-[0_15px_40px_rgba(0,0,0,0.35)]'>
                                    <p className='text-[0.6rem] uppercase tracking-[0.3rem] text-white/60'>Limited Edition</p>
                                    <p className='mt-2 text-2xl font-bold text-[#F5BB0B] md:text-3xl'>TVK CUP</p>
