                    ...
                    <div className='px-6 pt-24'>
                        <div className='relative rounded-2xl border border-white/6 bg-gradient-to-br from-[#07070a] to-[#0f1114] p-8 text-white shadow-inner'>
                            ...
                            <ul className='list-disc list-inside space-y-1 mt-2 text-white/80'>
                                ...
                                <li>31 January 2026 – 7th Prize: Royal Enfield 350</li>
                                <li>2 February 2026 – 6th Prize: Royal Enfield 350</li>
                                <li>7 February 2026 – 5th Prize: Royal Enfield 350</li>
                                <li>9 February 2026 – 4th Prize: Royal Enfield 350</li>
                                <li>14 February 2026 – 3rd Prize: Maruti Swift Car</li>
