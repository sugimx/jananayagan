            ...
            <div className='flex-1'>
              <div className='flex flex-col gap-4'>
                  <div className='flex flex-col gap-2'>
                    <label className='text-sm text-[#F5D57A] md:text-lg'>Name</label>
                    <input className='border-1 border-[#F5D57A] outline-none rounded-md py-1 px-2 md:py-2' name="name" placeholder='John Doe'/>
                  </div>
                    <div className='flex flex-col gap-2'>
                  ...
                  <div className='flex flex-col gap-2'>
                    ...
                    <input className='border-1 border-[#F5D57A] outline-none rounded-md py-1 px-2 md:py-2' type='password' name="password" placeholder='*********' />
                  </div>
                  <p className='text-sm md:text-md'>Do you have a account? <Link href="/login" className="underline text-[#F5D57A]">login</Link></p>
                  <button className='bg-[#F5D57A] text-black py-1 rounded-md cursor-pointer my-2 md:text-lg'>Create Account</button>
              </div>
