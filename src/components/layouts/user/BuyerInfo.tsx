            ...
            <div className='max-w-[1800px] mx-auto'>
                <div className='h-auto py-10 relative'>
                    <div>
                        ...
                        <p className='text-sm leading-relaxed my-1 md:text-lg md:my-4 text-white'>Fill in your details to receive your unique ID for the SUGIMX PRIVATE LIMITED.</p>
