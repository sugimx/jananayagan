...
const Invoice = () => {
  return (
    <>
        ...
        <Container>
            {/* style={{ position: 'absolute', left: '-9999px', top: 0, width: '100vw' }} */}
            <div id="download_container" className="w-[595px] h-[842px]" style={{ position: 'absolute', left: '-9999px', top: 0, width: '100vw' }}>
                <div className='py-8 px-8 text-[#F5D57A]'>
                    <div>
                        <h1 className='text-[2rem] font-bold'>Invoice</h1>
                        <p className='text-md my-4'>#27346733-022</p>
                        <div className='flex gap-18 items-center text-lg leading-relaxed'>
                            <span className='my-1'>Invoice Date</span>
                    ...
                    <div className='w-full h-[2px] bg-[#4a4a4a] flex my-2'></div>
                    <div className='flex font-semibold text-sm'>
                        <div className='flex-1 flex flex-col gap-2'>
                            <p className='my-1'>Billed To</p>
                            <p>Din Djarin</p>
                    ...
                    <div className='my-4'>
                        <p className='text-xs'>This is an invoice sample. This message is set as default. You can always change it to whatever you like. Feel free.</p>
                    </div>
                    <div>
                        <div className='text-md font-bold flex justify-between py-2 border-b-1 border-[#4a4a4a]'>
                    ...
                    <div className='my-4'>
                        <p className='text-xs'>This is a footer sample. You can add a special message to your user to thank them.</p>
                    </div>
                    <div className='text-sm border-t-1 border-[#4a4a4a] py-8 flex justify-between'>
