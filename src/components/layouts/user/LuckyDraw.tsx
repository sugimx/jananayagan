    ...
    return (
        <Container>
            <div className='my-10 md:my-20 md:mx-20'>
                <h1 className='text-center text-[1.5rem] text-[#F5D57A] font-semibold md:text-[3rem]'>Lucky Draw</h1>
                <div className='flex flex-col md:flex-row justify-around items-center border-1 border-[#F5D57A] rounded-lg md:rounded-4xl'>
                    <div className='my-4 mx-2 md:mx-6'>
                        <h1 className='text-[#F5D57A] text-[1rem] font-semibold mb-2 md:text-xl'>FAN REWARD SCHEME</h1>
